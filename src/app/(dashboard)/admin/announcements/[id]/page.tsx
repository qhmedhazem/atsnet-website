...
import AnnouncementBannerEditor from "@/features/announcements/components/Editor/AnnouncementBannerEditor";
...
export default async function AnnouncementManagementPage({
  ...
  return (
    ...
    >
      ...
      <AnnouncementBannerEditor announcement={announcement} />
